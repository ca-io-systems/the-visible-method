 ...
 * Keep in sync with studio-session thank-you copy (August 17 · 1–2:30 PM PT).
 */
 ...
 *
 * @returns WorkshopEvent with UTC start/end derived from 1:00–2:30 PM America/Los_Angeles on Aug 17, 2026
 */
